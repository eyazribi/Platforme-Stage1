...
<html lang="en">
    ...
    <body>
			...
			<div class="box">
				<div >
					...
					<div class="column " id="sidebar">
						...
						<ul class="nav">
							<li><a href="#"  class="visible-xs text-center"><i class="glyphicon glyphicon-chevron-right"></i></a></li>
						</ul>
		...
		snippets in the 100% free Bootply.com code repository.
							  ...
							  <a href="http://usebootstrap.com/theme/facebook" target="ext">Contact us </a>
							  </h4>
