...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            ...
            <!-- Image Logo -->
            <a class="navbar-brand logo-image"  style="color:white;">Stage</a> 
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="index.html#pricing">CONTACT</a>
                    </li>
                </ul>
                <span class="nav-item">
    ...
    <header id="header" class="ex-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>The Best Platform to find a suitable Internship</h1>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="index.html">Profile</a><i class="fa fa-angle-double-right"></i><span></span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="text-container">
                        <h3>Dynamique infos about the user </h3>
                        <p>infos such as name location etc </p>
